...
#define KIYARI_NAME "KIYARI"
#define KIYARI_VERSION "1.0.0"
...
#define BACKEND_BASE_URL "http://192.168.1.111:8001"     // Updated to new IP
#define BACKEND_WS_URL "ws://192.168.1.111:8001/ws/chat" // Updated to new IP
// Audio Buffer
